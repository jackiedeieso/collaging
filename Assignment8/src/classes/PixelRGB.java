...
public class PixelRGB implements PixelType {
  ...
  private CollagerModel controller;
  private Utils utils;
  ...
  public PixelRGB(int red, int green, int blue, CollagerState state,
                  CollagerModel controller, TextView view) {
    this.state = state;
  ...
  public PixelRGB(int red, int green, int blue, int alpha,
                  CollagerState state, CollagerModel controller, TextView view) {
    this.state = state;
    this.controller = controller;
    this.view = view;
    this.utils = new Utils(this.state, this.controller, this.view);
   ...
   */
  public PixelRGB(CollagerState state, CollagerModel controller) {
    this.state = state;
    this.controller = controller;
    /*
   ...
   */
  public PixelRGB(PixelHSL pixelHSL, CollagerState state, CollagerModel controller) {
