...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    if (args.length == 0) {
      ...
      TextView commandView = new TextView(commandState);
      Scanner sc = new Scanner(new FileInputStream(args[1]));
      CollagerController commandController = new CollagerController(commandState, commandView, sc);
      ...
      if (args.length == 2) {
        if (args[1].equals("GUI")) {
          ...
          TextView guiTextView = new TextView(guiState, guiBuffer, outputList);
      ...
      if (args.length == 1) {
        ...
        TextView textView = new TextView(textState);
